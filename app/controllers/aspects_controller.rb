class AspectsController < ApplicationController
  ...
  # GET /aspects.json
  def index
    @aspects = Aspect.all.order(:aspect)
  end
  ...
  def create
    ...
    respond_to do |format|
      if @aspect.save
        format.html { redirect_to aspects_url, notice: 'Aspect was successfully created.' }
  ...
  private
    ...
    def aspect_params
      params.require(:aspect).permit(:aspect, :keywords, :component1, :component2, :sources)
    end
end
